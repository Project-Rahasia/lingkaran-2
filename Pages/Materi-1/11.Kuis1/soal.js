const questions = [
  ...
  {
    question:
      "Jika panjang diameter sebuah lingkaran 10 cm, maka panjang jari - jari lingkaran tersebut adalah . . . cm.",
    answers: {
      a: "20",
      b: "15",
      c: "10",
  ...
  {
    question: "Titik yang terletak tepat di tengah lingkaran disebut . . . .",
    answers: {
      a: "Titik diameter",
      b: "Titik sumbu",
      c: "Titik potong",
  ...
  {
    question:
      "Jika panjang jari - jari sebuah lingkaran 2 cm, maka panjang diameter lingkaran tersebut adalah . . . cm.",
    answers: {
      a: "10",
      b: "8",
      c: "6",
